...
/***/ function(module, exports, __webpack_require__) {
	...
	function editChapter() {
	  ...
	  if (checkPendingEdits(this.editsPending, this, 'You already have work pending on a new chapter!  Do you want to proceed to ' + 'discard this work, or cancel your request to edit the existing chapter?')) {
	    return;
	  } else {
	    this.editsPending = false;
	    window.onbeforeunload = null;
	...
	function validateResponse(properThis, response, newWindowPosition) {
	  ...
	  if (location.href.indexOf('?') > -1 && response && !response.msg && !response.warning && !response.error) {
	  ...
	  if (!response.hasOwnProperty('draftPath') || !response.hasOwnProperty('draftBody')) {
	...
	var Node = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(GenerateLinkUi, { nodeUid: context.state.nodeUid })
	    );
	  },
	...
	var ModificationsAndOptionsComponent = React.createClass({
	  ...
	  render: function () {
	    ...
	    var genLinkButtonElement = React.createElement(
	      'button',
	      { id: 'cyoag-generate-link-button', className: 'cyoag-side-spaced-button cyoag-tooltip-button shaded-border-blue', onClick: this.showGeneratedLink },
	      React.createElement(
	        'span',
	        null,
	        'Generate link'
	    ...
	    modsAndOptsMsgElement = React.createElement(
	      'p',
	      { id: 'cyoag-mods-and-opts-message', className: 'cyoag-note' },
	      modsAndOptsMsg
	    );
